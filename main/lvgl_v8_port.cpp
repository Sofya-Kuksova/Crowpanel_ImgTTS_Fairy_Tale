...
bool lvgl_port_start(void)
{
...
#if LVGL_PORT_AVOID_TEAR
    /* Для non-RGB (или в зависимости от bus_type) — attach refresh finish callback */
    // Предполагается, что lcd указатель/объект доступен в области видимости или вы храните его глобально.
    ...
    ESP_UTILS_LOGI("LVGL task started");
    return true;
}
